...
public class Entrada {
    ...
    public static void main(String[] args) {
       ...
       /* File file = new File("src/main/java/resources/usuario.txt"); //conectando con el json usuario.txt
        // txt -> JSON
        BufferedReader bufferedReader = null; //para leer toda la linea del json
